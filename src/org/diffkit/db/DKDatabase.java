...
public class DKDatabase {
	...
	public DKDBTypeInfo getConcreteTypeInfo(String dbTypeName_)
			throws SQLException {
		DKDBType concreteType = DKDBType.getConcreteType(this.getFlavor(),
				dbTypeName_);
		if (_isDebugEnabled)
			_log.debug("dbTypeName_->{} concreteType->{}", dbTypeName_,
					concreteType);
	...
	public DKDBTypeInfo[] getColumnTypeInfos(DKDBTable table_)
			throws SQLException {
	...
	public DKDBTypeInfo[] getColumnConcreteTypeInfos(DKDBTable table_)
			throws SQLException {
		DKDBColumn[] columns = table_.getColumns();
		if (ArrayUtils.isEmpty(columns))
			return null;
	 ...
	 *         columns of Type not supported by particular flavor will be
	...
	public DKDBTable createTable(DKDBTable table_) throws SQLException {
		...
		return this.getTable(table_.getCatalog(), table_.getSchema(),
				table_.getTableName());
	}
	 ...
	 */
	public String generateInsertDML(Object[] rowValues_, DKDBTable table_)
			throws SQLException {
	...
	public String generateInsertDML(Object[] values_,
		...
		return _sqlGenerator.generateInsertDML(values_, typeInfos_,
				columnNames_, schemaName_, tableName_);
	}

	/**
	 * convenience that delegates to underlying SqlGenerator
	 */
	public List<String> generateInsertDML(List<Map<String, ?>> rows_,
	...
	public boolean insertRow(Map<String, ?> row_, DKDBTable table_)
			throws SQLException {
		if ((table_ == null) || (row_ == null))
			return false;
	...
	public List<Map<String, ?>> readAllRows(DKDBTable table_)
			throws SQLException {
		if (table_ == null)
			return null;
